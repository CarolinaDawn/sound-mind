...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF597688);
  late Color secondary = const Color(0xFFA27D65);
  late Color tertiary = const Color(0xFFD17562);
  late Color alternate = const Color(0xFFB6CCD2);
  late Color primaryText = const Color(0xFF4A4A4A);
  late Color secondaryText = const Color(0xFFB6CCD2);
  late Color primaryBackground = const Color(0xFFFCFFFE);
  late Color secondaryBackground = const Color(0xFFF9F4E6);
  late Color accent1 = const Color(0x4C597688);
  late Color accent2 = const Color(0x4DA27D65);
  late Color accent3 = const Color(0x4DD17562);
  late Color accent4 = const Color(0x4DB6CCD2);
